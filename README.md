...
# Как запустить python приложение на windows 


Не закрывая командную строку, перейдите в соответствующую директорию при помощи:
...
И можете запускать файл:

![Screenshot_9-1801-396653](https://github.com/JuicyS8da/carbis-address-locator/assets/118248275/dab34cea-a394-4646-9e4c-86c931ef252a)
